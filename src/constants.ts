...
export const BOARD_MARGIN = 14;
export const GAME_START_TEXT_SHOW_DURATION = 1000;
export const SNAKES_AND_LADDERS_COUNT = 14;
export const MAX_PLAYER_NAME_LENGTH = 25;
export const MAX_PLAYER_COUNT = Object.keys(TokenColors).length;
